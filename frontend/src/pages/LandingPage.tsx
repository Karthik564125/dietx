            ...
            <div className="flex-1 text-center lg:text-left space-y-8 lg:space-y-12 order-2 lg:order-1">
               ...
               <div className="max-w-md mx-auto lg:mx-0 w-full">
                  <button
                     ...
                     className="w-full flex items-center justify-between group bg-emerald-500/80 backdrop-blur-xl text-white p-5 sm:p-7 rounded-[1.5rem] sm:rounded-[2.5rem] text-lg sm:text-xl font-black hover:bg-emerald-500 hover:-translate-y-1 transition-all duration-500 shadow-2xl shadow-emerald-900/30 border border-emerald-400/30"
                  >
                     <span>Start Journey</span>
                     <div className="w-10 h-10 sm:w-14 sm:h-14 bg-white/15 rounded-full flex items-center justify-center group-hover:bg-white group-hover:text-emerald-600 transition-all">
